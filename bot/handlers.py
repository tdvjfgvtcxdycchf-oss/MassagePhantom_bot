...
CONSENT_TEXT = (
    ...
    "• 🗑 Удалённые сообщения — видишь что именно было написано\n"
    "• ✏️ Отредактированные сообщения — видишь что было до правки\n"
    "• 👁 Одноразовые медиа (view-once) — бот перехватывает и пересылает тебе до исчезновения\n\n"
    "<b>Конфиденциальность:</b>\n"
    "• Удаления и правки детектируются в течение <b>7 дней</b> с момента отправки — текст сообщений хранится на сервере этот срок, затем автоудаление\n"
    "• Сессия твоего аккаунта хранится в зашифрованном виде и используется исключительно для мониторинга чатов — отслеживания удалений, правок и одноразовых медиа\n"
